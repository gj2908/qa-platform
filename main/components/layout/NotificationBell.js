...
import { DropdownMenu, DropdownMenuTrigger, DropdownMenuContent } from "../shadcn/dropdown-menu";

export default function NotificationBell() {
  const { items, unreadCount, loaded, dismiss, clearAll, markRead } = useNotifications();

  return (
    <DropdownMenu onOpenChange={(open) => open && unreadCount > 0 && markRead()}>
      ...
      <DropdownMenuContent align="end" className="w-80 max-w-[calc(100vw-2rem)] p-1.5">
