...
description: >-
  ...
  AGENTS.md files — root, main/, admin/ — and updates whichever ones have
  ...
  inline. Not meant to fire on every single file edit — AGENTS.md is a
...
This repo has three AGENTS.md files: the root one (map of the two-app/
shared-database shape), `main/AGENTS.md`, and `admin/AGENTS.md`. They're
...
Update AGENTS.md when a change introduces one of:
...
Do NOT update AGENTS.md for: routine feature additions that don't
...
3. Write updates in the same terse, high-signal style already used in
   ...
   turn AGENTS.md into a changelog; it describes current state and
